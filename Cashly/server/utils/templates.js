// Pre-configured MSME business templates
const templates = {
    kirana: {
        name: 'Kirana Store',
        type: 'Retail',
...
// Apply template to create recurring transactions
const applyTemplate = (templateKey) => {
    ...
    return {
        ...
        suggestedRecurring: template.recurringExpenses.map(e => ({
            type: 'Expense',
            category: e.category,
            frequency: e.frequency,
            suggestedAmount: e.typical,
            description: `Monthly ${e.category}`
        })),
        tips: template.tips
    };
};
